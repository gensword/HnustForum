...
@section('content')
    ...
    <div class="row" style="">
        <div class="col-md-3" style="background-color:white; border: #e5e5e5 1px solid; text-align: center;min-height: 150px; margin-bottom: 30px">
        ...
        <div class="col-md-8 hidden-xs"  style="background-color:white; border: #e5e5e5 1px solid;min-height: 250px;margin-left: 50px">
            ...
            <div class="col-xs-12 visible-xs-block"  style="background-color:white; border: #e5e5e5 1px solid;min-height: 250px">
                ...
                @if(count($talks))
                    @foreach($talks as $talk)
                        <div class="row" style="margin-left: 15px">
                            <div class="col-md-1 col-xs-4"><a href="{{ url('/users/'.\App\Husers::find($talk->from_uid)->id) }}"><img src="{{ \App\Husers::find($talk->from_uid)->avatar }}" alt="..." class="img-circle img-responsive" > </a></div>
                            <div class="col-md-4"><p>
                                    @if( \App\Husers::find($talk->from_uid)->id == Auth::id() )
                                        我
                                    @else
